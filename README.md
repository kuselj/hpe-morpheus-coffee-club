...
- [Build and Run](#build-and-run)
  ...
  - [1. `dev` Profile — Local Coding with Hot Reload](#1-dev-profile--local-coding-with-hot-reload)
  - [2. `prod` Profile — Local Executable Standalone JAR](#2-prod-profile--local-executable-standalone-jar)
  - [3. `prod-cloud` — Automated Render Deployment via Docker](#3-prod-cloud--automated-render-deployment-via-docker)
- [Testing](#testing)
